...
<body class="<?php print $classes; ?>" <?php print $attributes;?>>
  ...
  <script>
    // @todo you might need to replace this cdn value or derive it from the server this is being placed on
    var cdn="/sites/all/libraries/webcomponents/";var old=false;
    try { new Function('import("")'); } catch (err) {
      ...
      var defs = [cdn + "build/es5-amd/node_modules/web-animations-js/web-animations-next-lite.min.js", cdn + "build/es5-amd/node_modules/promise-polyfill/dist/polyfill.min.js", cdn + "build/es5-amd/node_modules/fetch-ie8/fetch.js", cdn + "assets/babel-top.js", cdn + "build/es5-amd/node_modules/@webcomponents/webcomponentsjs/webcomponents-loader.js"];
      defs.push(cdn + "build/es5-amd/build.js");
      if (window.customElements) { // modernish FF or Safari that may not support dynamic import
        defs.push(cdn + "build/es6/node_modules/@webcomponents/webcomponentsjs/custom-elements-es5-adapter.js");
      }
  ...
  <script type="module" src="/sites/all/libraries/webcomponents/build/es6/build.js"></script>
