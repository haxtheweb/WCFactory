# Deprecated
While powerful, this tooling is in legacy mode. Please use it's successful [@haxtheweb/create](https://github.com/haxtheweb/create) which is smaller, faster, and more maintainable.

`npm init @haxtheweb`
or
`npx @haxtheweb/create`

to get started building  web components
...
[![Build Status](https://travis-ci.com/haxtheweb/wcfactory.svg?branch=master)](https://travis-ci.com/haxtheweb/wcfactory)
...
### Quick Install
```bash
curl -fsSL https://raw.githubusercontent.com/haxtheweb/wcfactory/master/wcfactoryme.sh -o wcfactoryme.sh && sh wcfactoryme.sh
```
